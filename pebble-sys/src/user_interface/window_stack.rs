...
unsafe extern "C" {
	...
	pub safe fn window_stack_pop(animated: bool) -> Option<HWindow>;
	pub safe fn window_stack_pop_all(animated: bool);
	pub fn window_stack_remove(window: HWindow, animated: bool) -> bool;
	pub safe fn window_stack_get_top_window() -> Option<HWindow>;
